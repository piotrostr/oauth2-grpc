...
type AuthServiceClient interface {
	CreateAccount(ctx context.Context, in *UserDetails, opts ...grpc.CallOption) (*Token, error)
...
type AuthServiceServer interface {
	CreateAccount(context.Context, *UserDetails) (*Token, error)
...
func (UnimplementedAuthServiceServer) CreateAccount(context.Context, *UserDetails) (*Token, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAccount not implemented")
}
func (UnimplementedAuthServiceServer) Authenticate(context.Context, *Credentials) (*Token, error) {
